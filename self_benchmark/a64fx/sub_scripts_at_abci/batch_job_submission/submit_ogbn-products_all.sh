...
qsub -g $GROUP_ID -o $output_dir -e $output_dir ./run_ogbn-products_8.sh
qsub -g $GROUP_ID -o $output_dir -e $output_dir ./run_ogbn-products_16.sh
qsub -g $GROUP_ID -o $output_dir -e $output_dir ./run_ogbn-products_32.sh
qsub -g $GROUP_ID -o $output_dir -e $output_dir ./run_ogbn-products_64.sh
