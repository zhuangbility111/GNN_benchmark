GROUP_ID=gac50544
output_dir=ogbn-papers100M/log/
...
qsub -g $GROUP_ID -o $output_dir -e $output_dir ./run_ogbn-papers100M_32.sh
qsub -g $GROUP_ID -o $output_dir -e $output_dir ./run_ogbn-papers100M_64.sh
